...
ALTER TABLE profile CHANGE COLUMN aadhar aadhar VARCHAR(255) NULL;
ALTER TABLE profile CHANGE COLUMN is_aadhar_verified is_aadhar_verified TINYINT(1) NULL DEFAULT 0 ;
ALTER TABLE personal_profile CHANGE COLUMN blood_donate_willingness blood_donate_willingness VARCHAR(255) NULL;
