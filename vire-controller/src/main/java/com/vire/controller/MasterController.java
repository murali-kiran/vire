...
public class MasterController {
    ...
    @Operation(summary = "Retrieve All Paged Master ")
    @ApiResponses(value = {
    ...
    public ResponseEntity<PagedResponse<MasterResponse>> retrieveAllPaged(
        ...
        return new ResponseEntity<>(masterService.getAllPaged(pageNumber, pageSize), HttpStatus.OK);
    }
